...
export default function About() {
  return (
    <>
      <Head>
        <title>About Us | Go-Construction</title>
        <meta
          name="description"
          content="Learn about GoConstruction, a leading construction company dedicated to building high-quality homes, commercial spaces, and infrastructure projects with expertise and passion."
        />
        <meta
          name="keywords"
          content="construction, home building,Residential Projects, Premium Residential, commercial projects, GoConstruction, Individual House , 1200 Squareft"
        />
        <meta name="robots" content="index, follow" />
      </Head>

      <div className="flex flex-col scroll-mt-52">
        {/* Hero Section */}
        <section
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-10 place-content-center items-center">
              <div className="flex flex-col max-w-2xl ">
                ...
                <p className=" mr-auto text-gray-600 leading-relaxed">
                  ...
                  big or small. From residential homes to commercial projects
                  and everything in between, we bring expertise, reliability,
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-1 gap-12">
            <motion.div
              ...
              <p className="text-gray-700 leading-relaxed">
                To be a leader in the construction industry, setting the
                benchmark for innovation, quality, and sustainability, while
                creating spaces that inspire and contribute to a better future.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 50 }}
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                relationships and building structures that stand the test of
                time.
              </p>
            </motion.div>
          </div>
          ...
          <div className="bg-gradient-to-r from-yellow-600/50  to-yellow-400/50 py-32 text-center">
            <motion.div
              ...
              <p className="text-white mb-8 max-w-2xl mx-auto">
                Whether you&apos;re planning a new project, renovating an
                existing space, or maintaining your property, GoConstruction is
