...
export default function Project() {
  ...
  return (
    <>
      <Head>
        <title>Our Projects | Go-Construction</title>
        <meta
          name="description"
          content="Explore Go-Construction's featured projects showcasing excellence in construction and innovation. See our portfolio of successful projects."
        />
        <meta
          name="keywords"
          content="construction projects, Go-Construction, building projects, real estate, infrastructure, architecture,Premium Residential,Residential ,Individual House 1200 Squareft,Individual House 900 Squareft,Individual House,duplex house,go construction projects,projects, go construction company projects,interior Design,Elevation Design, Elevation"
        />
      </Head>
      <div className="relative flex flex-col scroll-mt-52" id="projects">
        {/* Hero Section */}
